...
import static project_mini_chat.FMiniChatClientDemo.setting;
...
public class FMiniChatServer extends javax.swing.JFrame {
    ...
    private void btn_sendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_sendActionPerformed
        if(setting.getIp()!=null&&setting.getName()!=null&&setting.getPort()!=0){
            ...
            String message=txt_userName.getText().trim()+" : "+mess;
            try {
                        ...
                        try {
                            while(true){              
                               ...
                               // IPAddress = receivePacket.getAddress();
                                ...
                                defaultListModel.addElement(l.get(l.size()-1));
                                listMess.setModel(defaultListModel);
                                txt_userName.setText(setting.getName());
                                if(integers.isEmpty()){
                                    for(int i=0;i<integers.size();i++){
                                    if(integers.get(i)!=portClient){
                                        if(i==integers.size()){
                                            integers.add(portClient);
                                        }
                                    }    
                                }
                                }else{
                            ...
                            Logger.getLogger(FMiniChatServer.class.getName()).log(Level.SEVERE, null, ex);
                        }
                    }
                };
